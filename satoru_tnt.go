...
func (ss *SimState) ConfigNet() {
	...
	inItemLay := net.AddLayer("InputItem", []int{4, 1, 1, 4}, emer.Input)
	ctxItemLay := net.AddLayer("CortexItem", []int{4, 1, 1, 4}, emer.Hidden)
	outItemLay := net.AddLayer("OutputItem", []int{4, 1, 1, 4}, emer.Compare)
	inCategLay := net.AddLayer("InputCateg", []int{4, 1, 1, 1}, emer.Input)
	ctxCategLay := net.AddLayer("CortexCateg", []int{4, 1, 1, 1}, emer.Hidden)
	inCue := net.AddLayer("InputCue", []int{4, 4}, emer.Input)
	ctxCue := net.AddLayer("CortexCue", []int{4, 4}, emer.Hidden)
	pfc := net.AddLayer("PFC", []int{1, 4}, emer.Input)
	hippo := net.AddLayer("Hippo", []int{10, 10}, emer.Input)

	net.ConnectLayers(inItemLay, ctxItemLay, prjn.NewOneToOne(), emer.Forward)
	net.ConnectLayers(ctxItemLay, outItemLay, prjn.NewOneToOne(), emer.Forward)
	net.ConnectLayers(inCue, ctxCue, prjn.NewOneToOne(), emer.Forward)
	net.ConnectLayers(inCategLay, ctxCategLay, prjn.NewOneToOne(), emer.Forward)
	net.ConnectLayers(ctxCue, ctxItemLay, prjn.NewOneToOne(), emer.Forward)

	net.ConnectLayers(pfc, ctxItemLay, prjn.NewFull(), emer.Back)
